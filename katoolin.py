...
def main():
 ...
 \033[1;32m+ -- -- +=[ Author: inferno\033[1;m
 \033[1;32m+ -- -- +=[ 331 Tools \033[1;m
\033[1;91m[W] Before updating your system , please remove all Kali-linux repositories to avoid any kind of problem use Ctrl-c to quit.\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
